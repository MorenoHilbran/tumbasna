...
export async function processIncomingMessage(
    ...
    // 1.3. Cek jika pengguna sedang dalam alur konfirmasi Hapus Akun (Step 1 -> Step 2 -> Exec)
    if (deleteAccountStateMap.has(phoneNumber)) {
    ...
    // 1.4. Cek jika pengguna sedang dalam alur konfirmasi Hapus Produk (YA / BATAL)
    if (deleteProductStateMap.has(phoneNumber)) {
