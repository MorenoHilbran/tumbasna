...
async function main() {
  ...
  for (const b of buyersData) {
    ...
    // Seed DEMAND ProductEntries for buyers so blue markers show up on the map
    const buyerDemands = [
      { commodity: 'Beras IR64 / Pandan Wangi', price: 15000, qty: 800 },
      { commodity: 'Cabai Rawit Merah', price: 40000, qty: 250 },
    ];
